                            ...
                            {records.length === 0 ? (
                                ...
                                records.map((record) => (
                                    <tr key={record.id} className="hover:bg-[#0E4680] transition-colors text-center text-[10px] whitespace-nowrap text-blue-100">
                                        ...
                                        <td className="px-3 py-3 border-r border-[#125699]">{record.fecha}</td>
                                        <td className="px-3 py-3 border-r border-[#125699]">{record.fechaCosecha}</td>
                                        <td className="px-3 py-3 border-r border-[#125699]">{record.fechaSiembra}</td>
