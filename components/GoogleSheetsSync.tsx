  ...
  try {
    ...
    if (data.action === 'sync_data') {
      ...
      if (data.harvests && data.harvests.length > 0) {
        var headersH = ["id", "granja", "estanque", "fecha", "pre1Kilos", "pre1Gramos", "pre1Organismos", "pre2Kilos", "pre2Gramos", "pre2Organismos", "pre3Kilos", "pre3Gramos", "pre3Organismos", "pre4Kilos", "pre4Gramos", "pre4Organismos", "pre5Kilos", "pre5Gramos", "pre5Organismos", "finalKilos", "finalGramos", "finalOrganismos", "totalOrganismos", "totalKilos", "pesoPromedioPrecosechado", "sobrevivenciaFinal"];
